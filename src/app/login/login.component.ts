    ...
    if(this.username!="" && this.password!=""){
      ...
      const bucket = new S3(
        ...
        while(!this.loginFinished){
                ...
                const params = {
                  ...
                  if (err) {
                    ...
                    try {
                      ...
                      if(!this.credentialMatch && loginobject.username == this.username && loginobject.password == this.password){
          ...
          console.log("login finishedgf ? " + this.loginFinished);
